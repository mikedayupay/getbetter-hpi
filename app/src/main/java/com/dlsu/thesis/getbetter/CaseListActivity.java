 ...
 * lead to a {@link CaseDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link CaseListFragment} and the item details
 * (if present) is a {@link CaseDetailFragment}.
 * <p/>
...
public class CaseListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.case_detail_container) != null) {
            ...
            ((CaseListFragment) getFragmentManager()
    ...
    /**
     * Callback method from {@link CaseListFragment.Callbacks}
